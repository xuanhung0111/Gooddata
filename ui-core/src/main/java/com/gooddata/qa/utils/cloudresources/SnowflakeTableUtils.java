...
public class SnowflakeTableUtils {
    ...
    public static final String COLUMN_ADDRESS = "A__ADDRESS";
    public static final String COLUMN_CITY = "A__CITY";
    public static final String COLUMN_BIRTHDAY = "D__BIRTHDAY";
    public static final String COLUMN_AGE = "F__AGE";
    public static final String COLUMN_AMOUNT = "F__AMOUNT";
