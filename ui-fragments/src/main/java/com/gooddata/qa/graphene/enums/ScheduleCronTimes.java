...
public enum ScheduleCronTimes {
    ...
    CRON_EVERYWEEK("every week", Arrays.asList("Sunday", "Monday", "Tuesday", "Wednesday",
            "Thursday", "Friday", "Saturday"), "${day} at ${hour}:${minute} UTC"),
    ...
    AFTER("after", null, "after ${triggerSchedule} completion");
