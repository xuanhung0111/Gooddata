...
public class LeaveConfirmNewInsightOnKDDialog extends AbstractFragment {

    private static By LEAVE_CONFIRM_DIALOG = By.className("s-unsave-change-confirmation-dialog");
    ...
    public static LeaveConfirmNewInsightOnKDDialog getInstance(SearchContext searchContext) {
        return Graphene.createPageFragment(
            LeaveConfirmNewInsightOnKDDialog.class, waitForElementVisible(LEAVE_CONFIRM_DIALOG, searchContext));
    }
