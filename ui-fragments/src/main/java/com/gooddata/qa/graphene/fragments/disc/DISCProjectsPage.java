...
public class DISCProjectsPage extends AbstractFragment {
	...
	public void checkProjectFilter(String filterOption, Map<String, String> projectsMap)
		...
		List<String> filterOutOptions = Arrays.asList(DISCProjectFilters.DISABLED.getOption(),
				DISCProjectFilters.FAILED.getOption(), DISCProjectFilters.RUNNING.getOption(),
	...
	public void checkPagingProjectsPage(String selectedProjectsPerPageOption, int projectsNumber) {
		...
		String pagingBarLabelSubString = String.format("Showing 1-%d of %d projects",
				projectsPerPageNumber, projectsNumber);
