...
public class NotificationRulesDialog extends AbstractFragment {
    ...
    public static final NotificationRulesDialog getInstance(SearchContext searchContext) {
        return Graphene.createPageFragment(NotificationRulesDialog.class,
    ...
    public NotificationRulesDialog createNotificationRule(NotificationRule notificationRule) {
