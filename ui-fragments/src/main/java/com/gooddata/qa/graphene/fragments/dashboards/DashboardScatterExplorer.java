...
public class DashboardScatterExplorer extends AbstractFragment {
    ...
    private static final By searchPropertyText =
            By.xpath("//div[contains(@class, 'searchfield')]//input[contains(@class, 'searchfield-input')]");
    ...
    private static final By tableContainer =
            By.xpath("//div[contains(@class,'dda-table-view')]/div[contains(@class, 'ember-table-tables-container')]");
    private static final By embeddedWidgetConfigAttributeButton =
            By.xpath("//div[contains(@class, 'edit-panel-block')]//button[contains(@class, 's-btn-select_attribute____')]");
    private static final By embeddedWidgetConfigXAxisButton =
            By.xpath("//div[contains(@class, 'edit-panel-block')]/label[contains(text(), 'X Axis')]/..//button");
    private static final By embeddedWidgetConfigYAxisButton =
            By.xpath("//div[contains(@class, 'edit-panel-block')]/label[contains(text(), 'Y Axis')]/..//button");
    private static final By embeddedWidgetConfigAttributeMetricButton =
            By.xpath("//div[contains(@class, 'edit-panel-block')]//button[contains(@class, 's-btn-select_attr__metric____')]");
    private static final By enableColorLink =
            By.xpath("//div[contains(@class,'edit-panel-block')]/a[@href='#' and text()='enable color']");
    private static final By addAdditionalColumnLink =
            By.xpath("//div[contains(@class,'edit-panel-block')]/a[@href='#' and text()='add additional column']");
    private static final By disableColorLink =
            By.xpath("//div[contains(@class,'edit-panel-block')]/a[@href='#' and text()='disable color']");
    private static final By removeAdditionalColumnLink =
            By.xpath("//div[contains(@class,'edit-panel-block')]//a[@href='#' and contains(@class,'dda-remove-icon-link')]");
    private static final By selectedDataPointInput =
            By.xpath("//div[contains(@class, 'edit-panel-block')][1]//button[not (contains(@class,'s-btn-select_attribute____'))]");

    private static final String widgetPropertyFolderLocator =
            "//div[contains(@class, 'is-collapsible')]/span[text()='${propertyFolderLabel}']";
    private static final String widgetAttributeLocator =
            "//div[contains(@class, 'type-attribute') and not(contains(@class, 'item-disabled'))]/span[text()='${propertyLabel}']";
    ...
    public void initScatterWidget(Map<String, String> data) {
        ...
        By attributeFolderWidget =
                By.xpath(widgetPropertyFolderLocator.replace("${propertyFolderLabel}",
                        data.get("dataPointFolder")));
        waitForElementPresent(attributeFolderWidget, browser).click();
        By attributeWidget =
                By.xpath(widgetAttributeLocator.replace("${propertyLabel}", data.get("dataPoint")));
        ...
        By xAxisWidget =
                By.xpath(widgetMetricLocator.replace("${propertyLabel}", data.get("xAxisMetric")));
        ...
        By yAxisFolderWidget =
                By.xpath(widgetPropertyFolderLocator.replace("${propertyFolderLabel}",
                        data.get("yAxisMetricFolder")));
    ...
    public void addColorToScatterWidget(Map<String, String> data) {
        ...
        waitForElementPresent(attributeFolderWidget, browser).click();
        By attributeWidget =
                By.xpath(widgetAttributeLocator.replace("${propertyLabel}",
    ...
    private void addOneColumnToScatterWidget(HashMap<String, String> data, String type) {
        ...
        if (type.equals("attribute")) {
            ...
            By metricWidget =
                    By.xpath(widgetMetricLocator.replace("${propertyLabel}", data.get("property")));
