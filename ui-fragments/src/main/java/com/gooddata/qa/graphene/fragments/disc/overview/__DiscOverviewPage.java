...
public class __DiscOverviewPage extends AbstractFragment {

    @FindBy(className = "overview-projects")
    private __OverviewProjects overviewProjects;

    public __DiscOverviewPage selectState(OverviewState state) {
    ...
    public __DiscOverviewPage waitForPageLoaded() {
