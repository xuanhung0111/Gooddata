...
public class DashboardSavedFiltersTest extends AbstractProjectTest{
    ...
    @Test(dependsOnGroups = {"init-data"}, groups = {"tests"}, priority = 1)
    ...
    @Test(dependsOnGroups = {"init-data"}, groups = {"tests"}, priority = 2)
    ...
    @Test(dependsOnGroups = {"init-data"}, groups = {"tests"}, priority = 3)
    ...
    @Test(dependsOnMethods = {"createSavedFilterViewTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"renameSavedFilterViewTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"filterViewNamingUniquenessTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"deleteSavedFilterViewTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"savedFilterAfterSwitchBetweenDashboardsAndPagesTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"savedViewFilterDoNotApplyOnTimeFilterAfterEditGranularityTest"}, groups = {"tests"})
    ...
    @Test(dependsOnMethods = {"savedViewFilterDoNotApplyOnFiltersAfterRemovingTest"}, groups = {"tests"})
