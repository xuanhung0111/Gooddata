...
public class AttributeLabelsTest extends AbstractProjectTest {
	...
	uploadCSV(csvFilePath + "attribute_labels.csv", columnIndexAndType,
		"attribute-labels");
    }
     ...
     loadProperty("sfdc.password")
     + loadProperty("sfdc.securityToken"));
     }
     ...
     createReport(hyperlinkReport, ReportTypes.TABLE, what, how,
