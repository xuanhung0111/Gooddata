...
public class DashboardRolePermissionsTest extends GoodSalesAbstractTest {
    private final String REPORT_TEST = "Report Test";
    private final String DASHBOARD_TEXT = "DASHBOARD TEXT";
    ...
    protected void initProperties() {
        ...
        projectTitle += "Dashboard Role Permissions Test";
    }
    ...
    @DataProvider(name = "viewerRoles")
    public Object[][] getViewerRoles() {
        return new Object[][]{
                {UserRoles.VIEWER},
     ...
     */
    @Test(dependsOnMethods = {"prepareData"}, groups = {"admin-tests"}, dataProvider = "viewerRoles")
    public void shouldShowPrivateDashboardWhenDrillingDashboardHasNotSACByViewerRoles(UserRoles userRoles) throws Exception {
        ...
        try {
            ...
            dashboardsPage.waitForReportLoaded(browser);
            dashboardsPage.clickOnAttributeItem("In Person Meeting");
            dashboardsPage.waitForReportLoaded(browser);
            String headline = dashboardsPage.getHeadLine();
    ...
    @Test(dependsOnMethods = {"prepareData"}, groups = {"admin-tests"}, dataProvider = "viewerRoles")
    public void shouldShowPrivateDashboardWhenDrillingDashboardHasSACByViewerRoles(UserRoles userRoles) throws Exception {
    ...
    @Test(dependsOnMethods = {"prepareData"}, groups = {"admin-tests"}, dataProvider = "viewerRoles")
    public void shouldBeShownPrivateDashboardWhenDrillingDashboardNotAddUserShareByViewerRoles(UserRoles userRoles) throws Exception {
        String PRIVATE_DASHBOARD = "Private Dashboard Not Add User Access " + generateHashString();
        String TARGET_TAB = "Target Tab" + generateHashString();
        String SOURCE_TAB = "Source Tab" + generateHashString();
        preparePrivateDashboard(PRIVATE_DASHBOARD);
        dashboardsPage.hasSAC();
        ...
        String PUBLIC_DASHBOARD = "Public Dashboard Not Add User Access " + generateHashString();
        String publicDashboardUri = preparePublicDashboard(PUBLIC_DASHBOARD);
        initDashboardsPage().selectDashboard(PUBLIC_DASHBOARD).renameTab(0, SOURCE_TAB).addReportToDashboard(REPORT_TEST);
        ChartReport chartReport = dashboardsPage.getContent().getReport(REPORT_TEST, ChartReport.class);
        chartReport.addDrilling(Pair.of(Arrays.asList(METRIC_NUMBER_OF_ACTIVITIES, ATTR_ACTIVITY_TYPE), TARGET_TAB), "Dashboards");
    ...
    @Test(dependsOnMethods = {"prepareData"}, groups = {"admin-tests"}, dataProvider = "viewerRoles")
    public void shouldBeShownPrivateDashboardWhenDrillingDashboardAddUserShareByViewerRoles(UserRoles userRoles) throws Exception {
