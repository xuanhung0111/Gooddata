...
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN;
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.DATASET_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN;
...
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.TABLE_DELETE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN;
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.TABLE_DELETE_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN;
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.TABLE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN;
import static com.gooddata.qa.utils.snowflake.SnowflakeTableUtils.TABLE_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN;
...
public class CustomSegmentMappingClientIdTest extends AbstractADDProcessTest {
    ...
    public Object[][] dataFirstLoadHasClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN,
                ...
                DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN, PKCOLUMN_CUSKEY, PK_CUSKEY } };
    }
    ...
    public Object[][] dataFirstLoadNoClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN,
                ...
                DATASET_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN, PKCOLUMN_CUSKEY, PK_CUSKEY } };
    }
    ...
    public Object[][] dataSecondLoadHasClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN,
                TABLE_DELETE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN,
                ...
                DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN, PK_CUSKEY, asList("CUS3", "CUS5", "CUS6") } };
    }
    ...
    public Object[][] dataSecondLoadNoClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN, TABLE_DELETE_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN,
                ...
                datasetDeleteTimeStampDeleted().rows(asList("CUS2C", timeSecond)), DATASET_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN,
                PK_CUSKEY, asList("CUS3C", "CUS4C", "CUS5C") } };
    }
    ...
    public void checkSecondLoadNoClientId(String table, String deleteTable, CsvFile csvfile, CsvFile csvFileDelete,
            ...
            assertThat(executionLog, containsString(
                    String.format("datasets=[{dataset.%s, incremental, loadDataFrom=%s}]", dataset, lastSuccessful)));
            assertThat(executionLog,
    ...
    public Object[][] dataThirdLoadHasClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN,
                ...
                DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN, PK_CUSKEY, asList("CUS5", "CUS7", "CUS8"),
                asList("CUS7", "CUS8") } };
    }
    ...
    public void checkBasedOnDiscriminatorSameLoad(String table, String deleteTable, CsvFile csvfile, CsvFile csvFileDelete,
            ...
            throws SQLException, IOException {
        dataMappingProjectIdUtils.updateClientIdDataMapping(Pair.of(CLIENT_ID_1, CLIENT_ID_2));
        csvfile.saveToDisc(testParams.getCsvFolder());
        csvFileDelete.saveToDisc(testParams.getCsvFolder());
        log.info("This is path of CSV File :" + csvfile.getFilePath());
        snowflakeUtils.uploadCsv2Snowflake(LOCAL_STAGE, "", table, csvfile.getFilePath());
    ...
    public Object[][] dataFourthLoadHasClientId() throws IOException {
        return new Object[][] { { TABLE_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN,
                ...
                DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN, PK_CUSKEY, asList("CUS8", "CUS10", "CUS11"),
    ...
    private void setUpModel() {
        Dataset datasetMappingProjectId = new Dataset(DATASET_MAPPING_CLIENT_ID_NO_CLIENT_ID_COLUMN).withPrimaryKey(PK_CUSKEY)
                .withAttributes(ATTR_NAME).withFacts(FACT_AGE);
        Dataset secondDatasetMappingProjectId = new Dataset(DATASET_MAPPING_CLIENT_ID_HAS_CLIENT_ID_COLUMN)
