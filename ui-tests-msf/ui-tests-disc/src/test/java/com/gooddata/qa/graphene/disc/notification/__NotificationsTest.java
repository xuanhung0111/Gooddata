...
public class __NotificationsTest extends __AbstractDISCTest {
    ...
    public void checkEmptyStateNotificationList() {
        ...
        try {
            __NotificationRulesDialog dialog = __initDiscProjectDetailPage()
    ...
    public void createNotificationRuleWithInvalidEmailFormat() {
        ...
        try {
            NotificationRuleItem notifyItem = __initDiscProjectDetailPage()
                    .getProcess(process.getName())
                    .openNotificationRuleDialog()
    ...
    public void deleteNotificationRule() {
        ...
        try {
            __NotificationRulesDialog notificationRuleDialog = __initDiscProjectDetailPage()
                    .getProcess(process.getName())
                    .openNotificationRuleDialog();
