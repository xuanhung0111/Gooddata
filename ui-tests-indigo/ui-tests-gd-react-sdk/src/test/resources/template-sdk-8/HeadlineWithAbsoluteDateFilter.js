...
import { uriRef, newMeasure, newPositiveAttributeFilter, newAbsoluteDateFilter } from "@gooddata/sdk-model";
...
const filter = [newAbsoluteDateFilter(dateAttribute, from, to)];
